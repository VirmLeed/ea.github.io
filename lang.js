...
const langArr = {
    ...
    "Places" : {
        ...
        "ru" : "В нашем приложении собрано множество популярных мест начиная с мемориалов и ресторанов вплоть до отелей и пешеходных троп. Так как этого всё равно мало, наши пользователи могут сами добавлять и оценивать чужие добавленные места. Так же, если вы уже определились с выбранным отелем или кинотеатром, вы можете забронировать места прямо из нашего приложения!",
